        ...
        <div class="col-md-8 border rounded-lg p-5">
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <p class="py-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laboriosam rerum, maxime repellat, fugiat maiores nostrum voluptas quibusdam nam laudantium quasi iure incidunt iste consequuntur dicta velit deleniti dolores quos quo.</p>
                    <hr>
                    <p class="lead">$199</p>
